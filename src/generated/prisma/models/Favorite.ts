...
export type FavoriteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"productId" | "userId" | "createdAt", ExtArgs["result"]["favorite"]>
...
export interface FavoriteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const favoriteWithProductIdOnly = await prisma.favorite.findMany({ select: { productId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Favorites and only return the `productId`
   * const favoriteWithProductIdOnly = await prisma.favorite.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Favorites and only return the `productId`
   * const favoriteWithProductIdOnly = await prisma.favorite.updateManyAndReturn({
   *   select: { productId: true },
   *   where: {
   *     // ... provide filter here
   *   },
