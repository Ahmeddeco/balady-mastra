import { getAllProductsForProductsPage, getAllProductsForProductsServerPage, getNonTrendingProducts, getOneProductById, getOneProductBySlug } from "@/dl/products.data"
...
export type getNonTrendingProductsType = Awaited<ReturnType<typeof getNonTrendingProducts>>