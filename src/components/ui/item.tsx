...
function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn("flex w-fit items-center gap-2 text-lg leading-snug font-bold", className)}
			{...props}
		/>
	)
}
...
function ItemDescription({ className, ...props }: React.ComponentProps<"p">) {
	return (
		<p
			...
			className={cn(
				"text-muted-foreground line-clamp-2 text-sm leading-normal font-normal text-balance text-start",
