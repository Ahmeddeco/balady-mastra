...
export default function AddYieldForm({ allCattle }: Props) {
		...
		<Form id={form.id} action={action} onSubmit={form.onSubmit} className="space-y-6">
			<div className="grid lg:grid-cols-2 grid-cols-1 gap-6 lg:gap-8">
				...
				<Field>
					...
					<Select key={fields.cattleId.key} name={fields.cattleId.name} defaultValue={fields.cattleId.initialValue}>
						<SelectTrigger>
							<SelectValue />
						</SelectTrigger>
						<SelectContent>
				...
				<Field>
					...
					<Input
						...
						defaultValue={fields.hotCarcassWeight.initialValue}
					/>
				...
				<Field>
					...
					<Input
						...
						defaultValue={fields.boneWeight.initialValue}
					/>
				...
				<Field>
					...
					<Input
						...
						defaultValue={fields.fatWeight.initialValue}
					/>
				...
				<Field>
					...
					<Input
						...
						defaultValue={fields.wasteWeight.initialValue}
					/>
				...
				<Field>
					...
					<Input
						...
						defaultValue={fields.netYieldWeight.initialValue}
					/>
